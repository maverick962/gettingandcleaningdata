...
setwd("/Users/jamesromeo/coursera/gettingandcleaningdata")
...
write.table(tidy_dataset, "/Users/jamesromeo/coursera/gettingandcleaningdata/results/tidytxt.txt", quote = FALSE, sep = "\t", row.names = FALSE)
